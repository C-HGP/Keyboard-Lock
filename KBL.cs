...
//TODO
// On radiobutton1 click, hook keyboard from class LowLevelKeyboardHook

namespace KBL
{
    public partial class KBL : Form
    {
        private globalKeyboardHook llKeyboardHook = new globalKeyboardHook();
        public KBL()
        {
        ...
        private void lockKB_CheckedChanged(object sender, EventArgs e)
        {
            llKeyboardHook.hook();
        }

        private void unlockKB_CheckedChanged(object sender, EventArgs e)
        {
